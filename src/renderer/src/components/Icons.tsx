/** Small inline SVG icon set (stroke icons, 1.75px, currentColor). */
...
const paths: Record<IconName, ReactNode> = {
  ...
  sparkles: <path d="M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8zM5 18l.7 1.8L7.5 20.5l-1.8.7L5 23l-.7-1.8-1.8-.7 1.8-.7zM19 3l.6 1.4L21 5l-1.4.6L19 7l-.6-1.4L17 5l1.4-.6z" />,
  calendar: (
    <>
...
export function Icon({ name, size = 18, ...rest }: IconProps): ReactNode {
  return (
    <svg
      width={size}
      height={size}
